...
import sqlite3
from czsc.data.coin import get_kline
...
def main():
    ...
    # show_bi("BTCUSDT", CandlestickInterval.MIN15, datetime(2021, 5, 1))
    ...
    # show_bi("ETHUSDT", CandlestickInterval.MIN1, datetime(2021, 6, 1))

    ct1 = CzscTrader('BTCUSDT')
    ct1.open_in_browser()

    ct = CzscTrader('ETHUSDT',500)
    ct.open_in_browser()
